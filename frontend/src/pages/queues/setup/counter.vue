<template>
  <base-card class="relative w-32 h-32 flex justify-center items-center cursor-pointer">
    <p class="absolute text-center">
      <span class="block text-grey-light text-sm">Counter</span>
      <span>{{ counter.label }}</span>
    </p>
    <div class="absolute pin group">
      <div class="absolute pin group-hover:bg-blue-dark opacity-25">
      </div>
      <div class="absolute pin hidden group-hover:flex group-hover:items-center group-hover:justify-center text-2xl">
